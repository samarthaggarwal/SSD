...
def network(input_shape):
    ...
    x_12 = doubleBlazeBlock(x_11, strides=2)
    x_13 = doubleBlazeBlock(x_12)
    x_14 = doubleBlazeBlock(x_13)
    x_15 = doubleBlazeBlock(x_14, strides=2)
    x_16 = doubleBlazeBlock(x_15)
    x_17 = doubleBlazeBlock(x_16)

    model = tf.keras.models.Model(inputs=inputs, outputs=[x_8, x_11, x_14, x_17])
    return model
